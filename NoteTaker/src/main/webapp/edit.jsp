...
<body>
 ...
 <div class="container">-<!-- fluid p-0 m-0 -->
    ...
    <input value="<%=note.getId()%>" name="noteId" type="hidden">
		  ...
		  <div class="mb-3">
		    <label for="addedDate" class="form-label">Date</label>
		    <input name="addedDate" required type="addedDate" class="form-control" id="addedDate"
		     aria-describedby="emailHelp" placeholder="Enter here" value="<%=note.getAddedDate()%>"/>
		  </div>
